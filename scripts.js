...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function generateAndStoreData() {
        ...
        // JSON.stringify() is to convert a JavaScript object or array into a JSON string. This JSON string format is useful for sending data over a network,
    ...
    function displayStatistics() {
        ...
        const stats = {
            ...
            RuPay: {
                ...
                category: 'Live Banks',
                count: "1333",
                img: './images/RUPAY.png'
            }
        };
        
        // The information comes from an object called stats
